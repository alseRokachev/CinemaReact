...
const Search = () => {
    ...
    const inputValue = useSelector(state => state.searchValue.inputValue)
    const films = useSelector(state => state.filmsStore.films)
    ...
    return (
        <div className={'w-full flex flex-wrap justify-evenly'}>
            {films.map((film, index) => {
                if (film.name.toLowerCase().trim().includes(inputValue) || film.director.toLowerCase().trim().includes(inputValue)) {
                    return <div
