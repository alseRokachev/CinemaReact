...
const PlaylistFavourite = () => {
    ...
    return (
        <div className={'w-full flex flex-wrap justify-between'}>
            {favouritePlaylist.map((film, index) => {
                return <div
            ...
            {favouritePlaylist.length === 0 ?
                <div className={'text-slate-500 poppins flex h-[90vh] w-full items-center justify-center flex-col'}>
                    No favourites yet <img src="icons8-sad-ghost-100.png" alt="" className='w-20' />
                </div> : ''}
        </div>
    );
};

export default PlaylistFavourite;